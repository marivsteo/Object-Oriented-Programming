...
void GUI::connectSignals()
{
	...
	QObject::connect(this->showWatchlistButton, &QPushButton::clicked, this, &GUI::handleShowWatchlist);
}
...
void GUI::initGUIRepo()
{
	...
	QVBoxLayout* second_buttons = new QVBoxLayout;
	this->undoButton = new QPushButton{ "Undo" };
	this->redoButton = new QPushButton{ "Redo" };
	second_buttons->addWidget(this->undoButton);
	second_buttons->addWidget(this->redoButton);
	this->repositoryLayout->addLayout(second_buttons, 30, 0, 2, 1);
...
{
	this->watchlistModel = new WatchlistModel{ ctrl };
	...
	buttons->addWidget(showWatchlistButton);
...
void GUI::handleShowWatchlist()
{
	watchlistModel = new WatchlistModel(this->ctrl);
